const UnderConstruction = () => {
    return (
        <div className="container mx-auto my-3 px-2 grid gap-8 | md:px-3">
            <header className=" hover:cursor-pointer | sm:text-lg font-inconsolata ">
                <a href="/" className="logo | flex items-center gap-1 ">
                    <h1 className="font-light tracking-wide">Faiz Kirsten</h1>
                    <div className="w-16 h-0.5 bg-gray-700 rounded-lg transition-all duration-300"></div>
                </a>
            </header>
            <main className="grid gap-5 | md:">
                <div className="text-xl font-semibold font-lato | md:">
